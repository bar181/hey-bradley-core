    ...
    >
      ...
      <div className="mx-auto max-w-4xl space-y-6">
        {articles.map((article, idx) => (
          <article
            key={article.id}
            className={`group flex flex-col sm:flex-row gap-5 rounded-2xl p-4 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg opacity-0 animate-card-reveal ${effectClass}`}
