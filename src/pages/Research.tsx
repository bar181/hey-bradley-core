      ...
      <article className="max-w-3xl mx-auto px-6">
        ...
        <section className="py-16 border-t border-white/5">
          ...
          <p className="text-lg text-neutral-300 leading-relaxed mb-6">
            ...
            consistently finds that <strong className="text-white">40&ndash;65% of implementation
        ...
        <section className="py-16 border-t border-white/5">
          ...
          <div className="float-right ml-8 mb-6 w-72 hidden md:block">
            <img src="/previews/theme-agency.png" alt="Website taking shape in Hey Bradley" className="rounded-xl border border-white/10 shadow-lg w-full" />
            <p className="text-xs text-neutral-500 mt-2 text-center">A website materializes during a team discussion</p>
          </div>
          ...
          <p className="text-lg text-neutral-300 leading-relaxed mb-6">
            But nobody improved the whiteboard itself. Nobody built a tool for <strong className="text-white">the
          ...
          {/* Effort breakdown */}
          <div className="bg-white/5 border border-white/10 rounded-2xl p-8 my-10 clear-both">
            <h3 className="text-lg font-semibold mb-6 text-center">Development Effort Breakdown (2025)</h3>
            <div className="space-y-6">
              <div>
                <div className="flex justify-between text-sm mb-2">
                  <span className="text-neutral-400">Concept-to-Spec <span className="text-red-400">(the bottleneck)</span></span>
        ...
        <section className="py-16 border-t border-white/5">
          ...
          <p className="text-lg text-neutral-300 leading-relaxed">
            ...
            precision that the handoff was lossless. <strong className="text-white">The telephone
        ...
        <section className="py-16 border-t border-white/5">
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-white/5">
                ...
                <tr className="bg-emerald-500/5">
                  ...
                  <td className="py-4 pr-4 text-neutral-300">Prototype + AISP specs</td>
          ...
          <p className="text-lg text-neutral-300 leading-relaxed">
            ...
            <strong className="text-white"> survives all the way to production</strong> with
        ...
        <section className="py-16 border-t border-white/5">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-10">
            <img src="/previews/example-fitforge.png" alt="FitForge example site" className="rounded-xl border border-white/10 w-full" />
            <img src="/previews/example-florist.png" alt="Florist example site" className="rounded-xl border border-white/10 w-full" />
          </div>

          <p className="text-lg text-neutral-300 leading-relaxed mb-6">
            <strong className="text-white">Software stops being a department and becomes a capability.</strong> Marketing
          ...
          <p className="text-lg text-neutral-300 leading-relaxed mb-6">
            <strong className="text-white">Decisions happen with artifacts, not arguments.</strong> &ldquo;I
          ...
          <p className="text-lg text-neutral-300 leading-relaxed">
            ...
            <strong className="text-white"> learn</strong> faster, respond faster, iterate faster.
      ...
      <section className="py-20 bg-gradient-to-b from-[#1a1a1a] to-[#242424] text-center">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            ...
            <Link to="/open-core" className="px-8 py-4 rounded-xl font-semibold border border-white/30 text-white hover:bg-white/10 transition-colors text-lg">
