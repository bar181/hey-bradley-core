...
- **Current Phase:** P66 / OC-MKTG SEALED — Marketing Site Polish. Welcome.tsx CTAs reframed (primary `Try the open source version →` + secondary `Explore AISP →` → bar181/aisp-open-core); social proof bar inserted (90 ADRs / 481 tests / 61/80 / 42K LOC / 2 days); blog preview section with 3 most recent posts (canonical Feature card style per ADR-091). HEADLINE_STATS in `src/data/progress-eval.ts` refreshed (was: 79 ADRs / 244 tests / 7 sprints; now: 90 / 481 / 14). Marketing-site audit at `plans/strategic-reviews/2026-05-01-marketing-site-audit.md` covers Welcome / OpenCore / AISP / Research; speed-demo + competitive-table + AISP-explained sections deferred. Predecessors: P65b / OC-2.5 Wave 2 (`e7b6af2`, Canonical Component Quality, 481/481 GREEN); P65 / OC-2.5 (`261d840`); P64 / OC-3 (`0701b37`); P63 / OC-2 (`ac6f973`); P62 / OC-1 (`6a86d5c`). Open planning phases: P61 (`64e305c`/`b1a9652`) + P61b (`8025878`). **481/481 cumulative PURE-UNIT GREEN.** ADR ledger: ADR-087 Design Token System (P65); ADR-088 Mode Architecture (P63); ADR-089 Agentics Data Model (P63); ADR-091 Canonical Component Quality (P65b); ADR-090 reserved for OC-5 Mobile UX. NEXT: OC-4 Templates Round 2 OR marketing-iteration-2 (speed-demo / competitive-table / AISP-explained) — owner choice.
...
- **ADRs:** 90 Accepted on disk; ADR-090 reserved. Range ADR-045 through ADR-091 with reserved-090. Recent additions: ADR-082 (Open Core RC, P58), ADR-083 (Test Library Architecture, P59), ADR-084 (Comprehensive QA Architecture, P60), ADR-085 (Multi-Page MVP, P61), ADR-086 (Process Pages content/runtime split, P61), **ADR-087 (Design Token System, P65 / OC-2.5)**, ADR-088 (Mode Architecture, P63 / OC-2), ADR-089 (Agentics Data Model, P63 / OC-2), **ADR-091 (Canonical Component Quality Standard, P65b / OC-2.5 Wave 2)**. **ADR-090 reserved → Mobile UX redesign (OC-5; pending owner UX-spec).** Numbering has 11 documented gaps (002-004, 006-009, 034-037) plus 3 stub-then-superseded duplicates (ADR-051/052/053 each have a P21 stub + a later Accepted file under the same number; see `docs/adr/README.md`).
...
- **Tests:** Cumulative **481/481 PURE-UNIT GREEN at P65b / OC-2.5 Wave 2 seal** (392 P60 baseline + 3 P60.5 + 10 P62 OC-1 + 20 P63 OC-2 + 14 P64 OC-3 + 11 P65 OC-2.5 + 31 P65b OC-2.5 Wave 2). P59 baseline = 298 Sprint N at `c00c2b7` + ~17 P58 RC + ~51 P59 prompt-library per ADR-083. P60 added 26 specs. Full corpus is 846+ tests across 73+ spec files (includes legacy + skipped suites); 481 is the curated PURE-UNIT seal-gate cumulative-regression subset.
