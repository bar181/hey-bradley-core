...
- **Current Phase:** P63 / OC-2 SEALED — 3-Card Onboarding Stub + Mode Architecture. ADR-088 Mode Architecture + ADR-089 Agentics Data Model Accepted (planning ADRs preserving design space for AW-1..AW-10). ModeSelectorCard component shipped standalone (160 LOC, 3 cards w/ verbatim owner copy; Whiteboard live, Planning + Agentics disabled w/ "Coming soon"); Onboarding.tsx integration deferred to owner UX review. uiStore patched (+42 LOC: AppMode + appMode + setAppMode + loadAppMode + kv['ui_app_mode']). 425/425 cumulative PURE-UNIT GREEN. Predecessors: P62 / OC-1 (Visual Polish Floor, 6a86d5c, 405 GREEN); P60.5 (`dabc638`); P60 (`fcb3c06`). Open planning phases: P61 (18-sprint OC roadmap, `64e305c`/`b1a9652`) + P61b (10-sprint AW roadmap, `8025878`). ADR-087 reserved for OC-5 Mobile UX (pending owner UX-spec). Sprints G/H/I-remainder/original-J-Agentic-Support deferred to Tier-2.
...
- **ADRs:** 88 Accepted on disk through ADR-089 (Agentics Data Model, P63 / OC-2; 087 reserved). Range ADR-045 through ADR-089 with one reserved gap. Recent additions: ADR-082 (Open Core RC, P58), ADR-083 (Test Library Architecture / prompt corpus, P59), ADR-084 (Comprehensive QA Architecture, P60), ADR-085 (Multi-Page MVP, P61), ADR-086 (Process Pages content/runtime split, P61), ADR-088 (Mode Architecture, P63 / OC-2), ADR-089 (Agentics Data Model, P63 / OC-2). ADR-087 (Mobile UX redesign for OC-5) reserved — drafted at OC-5 sprint open after owner UX-spec lands. Numbering has 11 documented gaps (002-004, 006-009, 034-037) plus 3 stub-then-superseded duplicates (ADR-051/052/053 each have a P21 stub + a later Accepted file under the same number; see `docs/adr/README.md`).
...
- **Tests:** Cumulative **425/425 PURE-UNIT GREEN at P63 / OC-2 seal** (392 P60 baseline + 3 P60.5 AISP-trace-auto-expand + 10 P62 OC-1 design-token spec + 20 P63 OC-2 mode selector spec). P59 baseline = 298 Sprint N at `c00c2b7` + ~17 P58 RC + ~51 P59 prompt-library per ADR-083. P60 added 26 specs (9 flagship + 6 LLM matrix + 6 personality + 5 templates). Full corpus is 846+ tests across 73+ spec files (includes legacy + skipped suites); 425 is the curated PURE-UNIT seal-gate cumulative-regression subset.
