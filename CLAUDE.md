...
- **Current Phase:** P67 / Polish Wave 2 SEALED — A2/A3/A4/A5 complete; A1 PARTIAL (3 ChatInput sub-components shipped: ChatInputBar 71 + ChatInputPersonalityPopover 121 w/ fade-in + ChatInputQuickActions 195; orchestrator refactor of 1013-LOC ChatInput.tsx DEFERRED — 2 parallel agent dispatches both timed out on the reduction scope; sub-components production-ready but not yet consumed). A2 swept 17 SectionSimple files (collapse-by-default + transition-all); A3 standardized CTAs across 8 marketing pages (`Try the open source version` + `Explore AISP`) + nav demo links + HEADLINE_STATS bumped to 528 tests / 91 ADRs / 51 phases / 15 sprints; A4 animation polish (mobile slide-up + listen thinking-beat + chat humanized typewriter); A5 ADR-093 Component Decomposition Standard + 42-case test spec + EOP. **570/570 cumulative PURE-UNIT GREEN** (was 528). Visual polish 7.3 → 7.9 (touched-surface 8.1). Predecessors: P66 Polish Wave 1 (`34699d4`); P66 / OC-MKTG (`62af4a4`); P65b (`e7b6af2`); P65 (`261d840`); P64 (`0701b37`); P63 (`ac6f973`); P62 (`6a86d5c`). Open planning: P61 (`64e305c`/`b1a9652`) + P61b (`8025878`). ADR ledger: ADR-087 Design Tokens; ADR-088 Mode Architecture; ADR-089 Agentics Data Model; ADR-091 Canonical Component Quality; ADR-092 Polish Sprint Architecture; **ADR-093 Component Decomposition Standard (P67)**; ADR-090 reserved for OC-5 Mobile UX. Carry-forward: ChatInput orchestrator refactor (P67b/P68); OC-5 mobile redesign; OC-4 templates Round 2; mobile real-device test; Polish Wave 3 (sub-page hero + listen-mode "real voice" feel). NEXT: P67b (close A1 carry-forward) OR OC-4 (templates) OR Polish Wave 3 — owner choice.
...
- **ADRs:** 92 Accepted on disk; ADR-090 reserved. Range ADR-045 through ADR-093 with reserved-090. Recent additions: ADR-082 (Open Core RC, P58), ADR-083 (Test Library Architecture, P59), ADR-084 (Comprehensive QA Architecture, P60), ADR-085 (Multi-Page MVP, P61), ADR-086 (Process Pages content/runtime split, P61), **ADR-087 (Design Token System, P65 / OC-2.5)**, ADR-088 (Mode Architecture, P63 / OC-2), ADR-089 (Agentics Data Model, P63 / OC-2), **ADR-091 (Canonical Component Quality, P65b / OC-2.5 Wave 2)**, **ADR-092 (Polish Sprint Architecture, P66 Wave 1)**, **ADR-093 (Component Decomposition Standard, P67 / Polish Wave 2)**. **ADR-090 reserved → Mobile UX redesign (OC-5; pending owner UX-spec).** Numbering has 11 documented gaps (002-004, 006-009, 034-037) plus 3 stub-then-superseded duplicates (ADR-051/052/053 each have a P21 stub + a later Accepted file under the same number; see `docs/adr/README.md`).
...
- **Tests:** Cumulative **570/570 PURE-UNIT GREEN at P67 / Polish Wave 2 seal** (392 P60 baseline + 3 P60.5 + 10 P62 OC-1 + 20 P63 OC-2 + 14 P64 OC-3 + 11 P65 OC-2.5 + 31 P65b OC-2.5 Wave 2 + 47 P66 Polish Sprint Wave 1 + 42 P67 Polish Wave 2). P59 baseline = 298 Sprint N at `c00c2b7` + ~17 P58 RC + ~51 P59 prompt-library per ADR-083. P60 added 26 specs. Full corpus is 846+ tests across 73+ spec files (includes legacy + skipped suites); 570 is the curated PURE-UNIT seal-gate cumulative-regression subset.
