...
- **Current Phase:** P62 / OC-1 SEALED — Visual Polish Floor (recon-corrected scope: copy was already real across the library; gap was design discipline). 6 templates touched (capstone + enterprise-saas + real-estate primary; bakery + florist + fun-blog typography secondary). 405/405 cumulative PURE-UNIT GREEN. P61 OPEN (Launch Planning, 18-sprint OC roadmap at `64e305c`/`b1a9652`) + P61b OPEN (Post-MVP Agentic Workbench Planning, 10-sprint AW roadmap at `8025878`) — both planning-only, parallel. ADR-085 Multi-Page MVP + ADR-086 Process Pages split Accepted. ADR-087 reserved for OC-5 Mobile UX (pending owner UX-spec). ADR-088/089 + ModeSelectorCard scaffold pending owner go. P60.5 quick win at `dabc638`; P60 sealed at `fcb3c06`. Sprints G/H/I-remainder/original-J-Agentic-Support deferred to Tier-2.
...
- **ADRs:** 86 Accepted on disk through ADR-086 (Process Pages Content/Runtime Split, P61). Range ADR-045 through ADR-086. Recent additions: ADR-082 (Open Core RC, P58), ADR-083 (Test Library Architecture / prompt corpus, P59), ADR-084 (Comprehensive QA Architecture, P60), ADR-085 (Multi-Page MVP, P61), ADR-086 (Process Pages content/runtime split, P61). ADR-087 (Mobile UX redesign for OC-5) pending — drafted at OC-5 sprint open after owner UX-spec lands. Numbering has 11 documented gaps (002-004, 006-009, 034-037) plus 3 stub-then-superseded duplicates (ADR-051/052/053 each have a P21 stub + a later Accepted file under the same number; see `docs/adr/README.md`).
...
- **Tests:** Cumulative **405/405 PURE-UNIT GREEN at P62 / OC-1 seal** (392 P60 baseline + 3 P60.5 AISP-trace-auto-expand + 10 P62 design-token spec). P59 baseline = 298 Sprint N at `c00c2b7` + ~17 P58 RC + ~51 P59 prompt-library per ADR-083. P60 added 26 specs (9 flagship + 6 LLM matrix + 6 personality + 5 templates). Full corpus is 846+ tests across 73+ spec files (includes legacy + skipped suites); 405 is the curated PURE-UNIT seal-gate cumulative-regression subset.
