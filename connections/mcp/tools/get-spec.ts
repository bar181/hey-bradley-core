...
export const getSpec: ToolDef<GetSpecInput, GetSpecOutput> = {
  ...
  async handler(input) {
    ...
    return {
      ...
      aisp: [
        { atom: 'INTENT', body: '⟦ Ω := { ... } ⟧', ambig: 0.04, density: 0.42 },
        { atom: 'PATCH', body: '⟦ Ω := { ... } ⟧', ambig: 0.04, density: 0.45 },
        { atom: 'SELECTION', body: '⟦ Ω := { ... } ⟧', ambig: 0.04, density: 0.41 },
        { atom: 'CONTENT', body: '⟦ Ω := { ... } ⟧', ambig: 0.04, density: 0.43 },
        { atom: 'ASSUMPTIONS', body: '⟦ Ω := { ... } ⟧', ambig: 0.04, density: 0.40 },
      ],
      tier,
      ambig: 0.04,
      density: 0.42,
