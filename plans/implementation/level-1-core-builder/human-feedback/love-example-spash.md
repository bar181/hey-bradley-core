...
// Initial showcase shown at start
...
// Conversation flow with triggers for showcase transitions
// Triggers are now on AI responses so transitions happen when AI starts responding
const CONVERSATION = [
  {
    type: "user",
  ...
  },
  {
    ...
    triggerShowcase: 0 // Listen Mode - triggers when AI responds
  },
  {
    type: "user", 
  ...
  },
  {
    ...
    triggerShowcase: 1 // Builder Mode - triggers when AI responds
  },
  {
    type: "user",
  ...
  },
  {
    ...
    triggerShowcase: 2 // Harvard - triggers when AI responds
  },
  {
    type: "user",
  ...
  },
  {
    ...
    triggerShowcase: 3 // AI Symbolic Protocol - triggers when AI responds
  },
  {
    type: "user",
  ...
  },
  {
    ...
    triggerShowcase: 4 // Creator - triggers when AI responds
  }
];

// Define showcase type
...
// Hero section showcases with different styles
...
const WelcomePage = () => {
  ...
  const [currentShowcaseIndex, setCurrentShowcaseIndex] = useState(-1); // Start with initial showcase
  ...
  // Typewriter effect with showcase sync
  useEffect(() => {
      ...
      const timeout = setTimeout(() => {
        setDisplayedMessages(prev => {
          ...
          if (newMessages.length <= currentMessageIndex) {
            // Start of a new message - trigger showcase if specified
      ...
      return (
        <div className={`absolute inset-0 ${INITIAL_SHOWCASE.gradient} rounded-2xl overflow-hidden`}>
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8 lg:p-12">
            ...
            >
              <Link to={INITIAL_SHOWCASE.link}>
                <button className={`px-8 py-4 rounded-xl font-semibold transition-all shadow-lg hover:shadow-xl ${INITIAL_SHOWCASE.ctaStyle}`}>
                  {INITIAL_SHOWCASE.cta}
                </button>
              </Link>
              <Link to={INITIAL_SHOWCASE.linkSecondary}>
                <button className={`px-8 py-4 rounded-xl font-semibold transition-all ${INITIAL_SHOWCASE.ctaSecondaryStyle}`}>
                  {INITIAL_SHOWCASE.ctaSecondary}
                </button>
              </Link>
            </motion.div>
          </div>
        ...
        return (
          <div className="absolute inset-0 rounded-2xl overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col items-start justify-center p-12 lg:p-16">
              ...
              >
                <Link to={currentShowcase.link}>
                  <button className={`px-8 py-4 rounded-xl font-semibold transition-all shadow-lg hover:shadow-xl ${currentShowcase.ctaStyle}`}>
                    {currentShowcase.cta}
                  </button>
                </Link>
                <Link to={currentShowcase.linkSecondary}>
                  <button className={`px-8 py-4 rounded-xl font-semibold transition-all ${currentShowcase.ctaSecondaryStyle}`}>
                    {currentShowcase.ctaSecondary}
                  </button>
                </Link>
              </motion.div>
            </div>
        ...
        return (
          <div className={`absolute inset-0 ${currentShowcase.backgroundColor} rounded-2xl overflow-hidden flex items-center justify-center`}>
            <div className={`text-center ${currentShowcase.accent} pl-8`}>
              ...
              >
                <Link to={currentShowcase.link}>
                  <button className={`px-10 py-4 font-medium transition-all ${currentShowcase.ctaStyle}`}>
                    {currentShowcase.cta}
                  </button>
                </Link>
                <Link to={currentShowcase.linkSecondary}>
                  <button className={`px-10 py-4 font-medium transition-all ${currentShowcase.ctaSecondaryStyle}`}>
                    {currentShowcase.ctaSecondary}
                  </button>
                </Link>
              </motion.div>
        ...
        return (
          <div className={`absolute inset-0 ${currentShowcase.gradient} rounded-2xl overflow-hidden`}>
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8 lg:p-12">
              ...
              >
                <Link to={currentShowcase.link}>
                  <button className={`px-8 py-4 rounded-sm font-semibold transition-all shadow-lg ${currentShowcase.ctaStyle}`}>
                    {currentShowcase.cta}
                  </button>
                </Link>
                <Link to={currentShowcase.linkSecondary}>
                  <button className={`px-8 py-4 rounded-sm font-semibold transition-all ${currentShowcase.ctaSecondaryStyle}`}>
                    {currentShowcase.ctaSecondary}
                  </button>
                </Link>
              </motion.div>
        ...
        return (
          <div className={`absolute inset-0 ${currentShowcase.gradient} rounded-2xl overflow-hidden`}>
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8 lg:p-12">
              ...
              >
                <Link to={currentShowcase.link}>
                  <button className={`px-8 py-4 rounded-xl font-semibold transition-all shadow-lg ${currentShowcase.ctaStyle}`}>
                    {currentShowcase.cta}
                  </button>
                </Link>
                <Link to={currentShowcase.linkSecondary}>
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      <div className="w-full max-w-[1200px] h-[calc(100vh-48px)] flex rounded-3xl overflow-hidden border border-border/50 shadow-2xl bg-background">
        {/* Left Panel - Chat */}
        <div className="w-[45%] flex flex-col bg-muted/20">
          {/* Chat Header */}
          <div className="p-6 border-b border-border/30 bg-background/80 backdrop-blur-sm">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="font-bold text-foreground text-xl">Hey Bradley</span>
                  <p className="text-sm text-muted-foreground">Agentic Design Platform</p>
                </div>
              </div>
              <Button
                variant="ghost"
                  ...
                  <div 
                    className={`max-w-[90%] rounded-2xl px-5 py-4 ${
                      message.type === "user" 
                        ...
                        : "bg-background border border-border/50 shadow-sm rounded-tl-sm"
                    }`}
                  >
                      ...
                      {index === displayedMessages.length - 1 && !message.isComplete && (
                        <motion.span
                          ...
                          className={`inline-block w-0.5 h-5 ml-1 align-middle ${
                            message.type === "user" ? "bg-primary-foreground" : "bg-primary"
                          }`}
                        />
                      )}
                    </p>
          ...
          {/* Chat Input Area */}
          <div className="p-5 border-t border-border/30 bg-background/80 backdrop-blur-sm">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ 
            ...
            >
              ...
              <Link to="/dashboard">
                <Button 
                  size="lg" 
                  className="w-full gap-2 text-lg font-bold h-14 rounded-xl shadow-lg hover:shadow-xl transition-all"
        ...
        <div className="flex-1 relative overflow-hidden bg-muted/10 p-4">
