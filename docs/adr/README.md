...
**Last updated:** 2026-05-07 (P118.5 / WALKTHROUGH) · **Total files on disk:** 138 · **Highest-ID:** ADR-147
...
**Policy:** New ADRs MUST continue at **ADR-148+**. Do NOT re-use any of the missing numbers above.
...
1. **Filename:** `ADR-NNN-kebab-case-title.md` where `NNN` is the next free number (currently ≥ 147).
...
**Last updated:** 2026-05-07 (P118.5 / WALKTHROUGH / single-agent closer — counter 137 → 138, ADR-147 row appended; bucket renamed "Post-RC hardening (P110-P118.5)"; policy line ADR-147+ → ADR-148+).
